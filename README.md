# 面试真题
- [面试真题](#----)
  * [1、腾讯-天美工作室群IEG-一面 2025.3.6](#1----------ieg----202536)
    + [1.1、protobuf序列化和反序列化过程，json和protobuf的使用场景](#11-protobuf-----------json-protobuf-----)
    + [1.2、如果查看一个已经运行的进程中某一个线程CPU的占用率？代码怎么大致计算？](#12--------------------cpu--------------)
    + [1.3、如何查看一个进程已经打开的文件描述符的数量](#13----------------------)
    + [1.4、手撕循环队列](#14-------)
