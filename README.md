...
- [面试真题](#----)
  ...
  * [3、某初创小型量化-量化系统开发实习生 2025.3.14](#3-某初创小型量化-量化系统开发实习生2025.3.14)
    + [3.1、池式结构的介绍](#31-池式结构的介绍)
    + [3.2、连接池详细追问](#32-连接池详细追问)
    + [3.3、线程池详细追问-线程数量的限制与线程执行任务数量](#33-线程池详细追问-线程数量的限制与线程执行任务数量)
    + [3.4、内存池详细追问-主要针对内存碎片处理的问题](#34-内存池详细追问-主要针对内存碎片处理的问题)
    + [3.5、网络编程epoll的连接量如何测试的，以及如何查看打开的文件描述符](#35-网络编程epoll的连接量如何测试的，以及如何查看打开的文件描述符)
    + [3.6、针对网络IO，Linux系统的操作流程或者网络数据在Linux内部是如何流转的](#36-针对网络IO，Linux系统的操作流程或者网络数据在Linux内部是如何流转的)
    + [3.7、网络IO主要的时延在哪，如何改进](#37-网络IO主要的时延在哪，如何改进)
    + [3.8、高并发和低时延矛盾吗？为什么？](#38-高并发和低时延矛盾吗？为什么？)
    + [3.9、MySQL和Hadoop的区别在哪？或者关系型数据库和非关系型数据库的区别在哪？](#39-MySQL和Hadoop的区别在哪？或者关系型数据库和非关系型数据库的区别在哪？)
    + [3.10、Linux系统调优有了解过吗？具体讲讲](#310-Linux系统调优有了解过吗？具体讲讲)
